...
/**
 * @author LYX
 * @create 2018-10-04 16:12
 */
public class ThreadLockTest {
    public static void main(String[] args) {
        Account_LOCK account = new Account_LOCK("123456", 0);
...
class DrawMoneyThread extends Thread {
    ...
    public DrawMoneyThread(String threadName, Account_LOCK account, double amount) {
        super(threadName);
...
class DepositeMoneyThread extends Thread {
    ...
    public DepositeMoneyThread(String threadName, Account_LOCK account, double amount) {
        super(threadName);
        this.account = account;
        this.amount = amount;
    }
